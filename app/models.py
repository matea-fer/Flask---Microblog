...
## The purpose of these two statements is
#  to set up the event handlers that will make SQLAlchemy call
#  the before_commit() and after_commit()
#  methods before and after each commit respectively.
